...
datoteka222 = "mhe_2024.csv"
podatki222 = pd.read_csv(PATH +"\\"+ datoteka222)

print(podatki222["Solar - Actual Aggregated [MW]"].sum())
...
pov = (df["Razlika"].sum()+df2["Razlika"].sum())/3
...
#output_path = PATH + "\\mhe_2024_entso.xlsx"
